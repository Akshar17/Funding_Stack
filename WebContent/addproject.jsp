...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="inno_projtitle" name="inno_projtitle" type="text" placeholder="Enter Project Title" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="inno_projabstract" name="inno_projabstract"></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="inno_projdescription" name="inno_projdescription"></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="inno_projtarget" name="inno_projtarget" type="text" placeholder="Enter Expected Fund" class="form-control input-md" required="">

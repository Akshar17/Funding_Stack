...
<title>Crowd View Specific Project</title>
</head>
<body>
...
<form class="form-horizontal" action="sponsorerviewallproject.jsp" method="post">
<!-- Form Name -->
<br>
<!-- Text input-->
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="inno_projtitle" value="<%=title %>" name="inno_projtitle" type="text" class="form-control input-md" required="" disabled>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="inno_projabstract" name="inno_projabstract" disabled><%=abs %> </textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="inno_projdescription" name="inno_projdescription" disabled><%=description %></textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="inno_projtarget" value="<%=expectedfund %>"name="inno_projtarget" type="text" class="form-control input-md" required="" disabled>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="inno_projsubmit"></label>
  <div class="col-md-3">
    <a href="fund.jsp" class="btn btn-success" role="button">Fund</a>
    <a href="chat.html" target="_blank" class="btn btn-warning" role="button">Chat</a>
    <a href="sponsorerviewallproject.jsp"  class="btn btn-danger" role="button">Cancel</a>
  </div>
</div>
</form>
</div>

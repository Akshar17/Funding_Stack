		...
		<nav class="navbar">
			...
			<div class="container-fluid">
				...
				<ul class="nav nav-pills navbar-nav navbar-right hover">
					<li><a href="SponsorerDashboard.jsp?success=none" class="navigation_font"> <span class="glyphicon glyphicon-home"></span> Home</a></li>
					<li><a href="sponsorerviewallproject.jsp?success=none" class="navigation_font"> <span class="glyphicon glyphicon-folder-open"></span>View All Projects</a></li>
					...
					<li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				        	<a class="dropdown-item" href="sponsorerprofile.jsp?success=none"><span class="glyphicon glyphicon-user"></span> My Profile</a><br>

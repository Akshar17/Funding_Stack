...
<form class="form-horizontal" action="CrowdOtpServlet" method="post">
<br>


<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="crow_otp">OTP</label>  
  <div class="col-md-4">
  <input id="crow_otp" name="crow_otp" type="text" placeholder="Enter OTP" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-3">
    <button id="crow_submit" name="crow_submit" class="btn btn-success" action="CrowdOtpServlet">Submit OTP</button>
    <button id="crow_reset" name="crow_reset" class="btn btn-danger">Cancel</button>
  </div>
</div>

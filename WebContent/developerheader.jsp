		...
		<nav class="navbar">
			...
			<div class="container-fluid">
				...
				<ul class="nav nav-pills navbar-nav navbar-right hover">
					...
					<li><a href="DeveloperDashboard.jsp?success=none" class="navigation_font"> <span class="glyphicon glyphicon-home"></span> Home</a></li>
					...
					<li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
				     	   ...
				     	   <a class="dropdown-item" href="viewproject.jsp?success=view"><span class="glyphicon glyphicon-folder-open">View Project</a>
				        </div>
      				</li>
